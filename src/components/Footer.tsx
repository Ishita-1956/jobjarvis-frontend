...
const footerLinks = {
    solutions: [
        { name: 'For Job Seekers', href: '/individuals' },
...
export default function Footer() {
    return (
        <footer className="relative bg-[#050510]">
            ...
            <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl py-20">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-12">
                    {/* Brand */}
                    <div className="col-span-2 lg:col-span-2 pt-2">
                        ...
                        <div className="flex items-center gap-3">
                            {socialLinks.map((social) => (
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-10 h-10 rounded-xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-slate-400 hover:text-white hover:border-blue-500/50 hover:bg-blue-500/10 transition-all"
                                >
                                    {social.icon}
                                </motion.a>
                            ))}
                ...
                <div className="mt-16 pt-8 border-t border-slate-800/30 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-slate-600 text-sm flex items-center gap-2">
                        ...
                        <span>for job seekers & recruiters everywhere</span>
                    </p>
                </div>
            </div>
        </footer>
