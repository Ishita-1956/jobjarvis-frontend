...
export default function VideoDemo() {
    ...
    return (
        <SectionWrapper id="video-demo" className="relative">
            {/* Background */}
                    ...
                    {!isPlaying ? (
                        ...
                        >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-3 gap-4 mb-4">
                                        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
                                            <div className="text-slate-400 text-sm mb-1">Applications</div>
                                            <div className="text-2xl font-bold text-white">247</div>
                                            <div className="text-green-400 text-xs mt-1">+12 today</div>
                                        </div>
                                        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
                                            <div className="text-slate-400 text-sm mb-1">Interviews</div>
                                        ...
                                        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
                                            ...
                                            <div className="text-2xl font-bold text-gradient">7.3%</div>
                                            <div className="text-slate-500 text-xs mt-1">Above average</div>
                                        </div>
                                    </div>
                            ...
                            <div className="absolute bottom-6 left-1/2 -translate-x-1/2">
                                <span className="px-5 py-2 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-400 text-sm font-medium backdrop-blur-md">
                                    ▶ Watch How It Works
                                </span>
                            </div>
