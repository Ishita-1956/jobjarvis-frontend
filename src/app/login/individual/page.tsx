                            ...
                            <div className="p-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full px-4 py-3.5 pl-12 bg-slate-800/60 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className="w-full px-4 py-3.5 pl-12 pr-12 bg-slate-800/60 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.99 }}
                                        className="w-full py-3.5 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 rounded-xl text-white font-semibold transition-all disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40"
                                    >
                                        {isLoading ? (
