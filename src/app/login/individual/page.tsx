...
export default function IndividualLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await loginWithCredentials(formData.emailOrId, formData.password, 'jobseeker');
                        ...
                        <div className="relative bg-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className="p-5">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full px-4 py-2.5 pl-10 bg-slate-800/60 border border-slate-700/50 rounded-lg text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className="w-full px-4 py-2.5 pl-10 pr-10 bg-slate-800/60 border border-slate-700/50 rounded-lg text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.99 }}
                                        className="w-full py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 rounded-lg text-white text-sm font-semibold transition-all disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40"
                                    >
                                        {isLoading ? (
                            ...
                            <div className="px-6 py-3 bg-slate-800/30 border-t border-slate-800/50 text-center">
                                <p className="text-slate-400 text-sm">
                                    ...
                                    <Link href="/signup/individual" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
                                        Sign up
                                    </Link>
                                </p>
                            </div>
