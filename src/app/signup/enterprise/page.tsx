                    ...
                    >
                        ...
                        <div className="relative bg-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className="px-8 pt-8 pb-6 text-center border-b border-slate-800/50">
                                <h2 className="text-2xl font-bold text-white mb-1">Create Enterprise Account</h2>
                                <p className="text-slate-400 text-sm">Scale your recruitment with Job Jarvis</p>
                            </div>
                            ...
                            <div className="px-8 py-5 bg-slate-800/30 border-t border-slate-800/50 text-center">
                                <p className="text-slate-400 text-sm">
                                    ...
                                    <Link href="/login/enterprise" className="text-violet-400 hover:text-violet-300 font-medium transition-colors">
                                        Sign in
                                    </Link>
                                </p>
                            </div>
